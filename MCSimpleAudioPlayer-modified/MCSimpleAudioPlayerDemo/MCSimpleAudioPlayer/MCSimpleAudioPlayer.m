...
@interface MCSimpleAudioPlayer ()<MCAudioInputQueueDelegate>//MCAudioFileStreamDelegate,
{
@private
    NSThread *_thread;
...
- (BOOL)createAudioQueue
{
    ...
    _audioQueue = [[MCAudioOutputQueue alloc] initWithFormat:defaultOutputFormat bufferSize:3996 macgicCookie:nil];
    if (!(_audioQueue.available && _recorder.available))
    {
        _audioQueue = nil;
        _recorder = nil;
        return NO;
