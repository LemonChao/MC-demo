...
@interface LCAddressCodePick ()<UIPickerViewDelegate,UIPickerViewDataSource>
{
...
@property (copy, nonatomic) void (^sele)(NSString *proviceStr,NSString *cityStr,NSDictionary *distDic);

@end

@implementation LCAddressCodePick
...
-(instancetype)initWithTWFrame:(CGRect)rect TWselectCityTitle:(NSString *)title{
    if (self = [super initWithFrame:rect]) {
        ...
        _AllARY = [NSArray arrayWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"Postcode" ofType:@"plist"]];
...
-(NSString*)pickerView:(UIPickerView *)pickerView titleForRow:(NSInteger)row forComponent:(NSInteger)component{
    if (component == 0) {
        ...
        NSDictionary *distDic = [_DistrictAry objectAtIndex:row];
        return distDic[@"name"];
...
-(void)showCityView:(void (^)(NSString *, NSString *, NSDictionary *))selectStr{
