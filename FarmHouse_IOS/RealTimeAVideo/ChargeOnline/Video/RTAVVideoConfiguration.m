...
{
    RTAVVideoConfiguration * configuration =  [RTAVVideoConfiguration defaultConfigurationForQuality:quality landscape:YES];
    return configuration;
}
...
+ (instancetype)defaultConfigurationForQuality:(RTVideoQuality)quality landscape:(BOOL)landscape
{
    ...
    switch (quality) {
        ...
        {
            sessionPreset     = kRTVideoSessionPreset352x288;
        ...
        case kRTVideoQuality_Common_Medium:
        {
            ...
            break;
        case kRTVideoQuality_Common_Medium123:
        {
            sessionPreset     = kRTVideoSessionPreset640x480;
            videoBitRate      = 600 * 1000;
            videoMaxBitRate   = 800* 1000;
...
- (NSString *)avsessionPreset
{
    ...
    switch (self.sessionPreset) {
        case kRTVideoSessionPreset352x288:
        {
        ...
        {
            avSessionPreset = AVCaptureSessionPresetiFrame960x540;//AVCaptureSessionPreset960x540
        }
            break;
