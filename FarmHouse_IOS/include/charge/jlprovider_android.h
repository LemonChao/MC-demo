#ifndef _JL_PROVIDER_ANDOIRD_H_7590673C_E9CA_4AD9_8AB1_A7DC784126F3
#define _JL_PROVIDER_ANDROID_H_7590673C_E9CA_4AD9_8AB1_A7DC784126F3
...
typedef struct {
	...
	jfieldID jfileReportNo;			//
	jfieldID jfileReportLen;		//
	jfieldID jfileIEventId;				//事件ID
	jfieldID jfileIsSendImg;		//发送图片状态
} JL_CBOBJ_t;
